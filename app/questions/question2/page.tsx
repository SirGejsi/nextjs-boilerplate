    ...
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-8 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      ...
      <main className="flex flex-col items-center">
        ...
        <p className="text-lg mt-2 italic">
          A customer has reached out asking, “When should I choose to use <strong>Edge Functions</strong>, <strong>Serverless Functions</strong>, or <strong>Edge Middleware</strong> with Vercel?” Write a reply to the customer.
        </p>
        ...
        <div className="bg-white border border-gray-300 rounded-lg shadow-md p-6 max-w-2xl mt-4">
          ...
          <br />
          <p className="text-sm text-black">
            Deciding between <strong>Edge Functions</strong>, <strong>Serverless Functions</strong>, or <strong>Edge Middleware</strong> on Vercel really depends on the use case and performance needs of your application. Here&apos;s a breakdown to help you decide:
          </p>
          <br />
